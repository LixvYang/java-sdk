...
public class PiliDomainManager extends PiliManager {
   ...
   * @throws QiniuException 异常
   */
  public QiniuException bindDomain(String hub, String domain, String type) throws Exception {
   ...
   * @throws QiniuException 异常
   */
  public QiniuException unbindDomain(String hub, String domain) throws Exception {
    HashMap<String, String> req = new HashMap<>();
    req.put("hub", hub);
    req.put("domain", domain);
    byte[] body = Json.encode(req).getBytes(Constants.UTF_8);
   ...
   * @throws QiniuException 异常
   */
  public QiniuException bindVodDomain(String hub, String vodDomain) throws Exception {
    HashMap<String, String> req = new HashMap<>();
    req.put("hub", hub);
