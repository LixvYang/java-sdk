...
public class PiliHubManager extends PiliManager {
   ...
   */
  public PiliHubModel.HubListResult getHubList() throws Exception {
   ...
   * @throws QiniuException 异常
   */
  public QiniuException hubSecurity(String hub, String publishSecurity, String publishKey) throws Exception {
   ...
   * @throws QiniuException 异常
   */
  public QiniuException hubHlsplus(PiliHubModel.HubHlsplusRequest param) throws Exception {
   ...
   * @throws QiniuException 异常
   */
  public QiniuException hubPersistence(PiliHubModel.HubPersistenceRequest param) throws Exception {
    byte[] body = Json.encode(param).getBytes(Constants.UTF_8);
   ...
   * @throws QiniuException 异常
   */
  public QiniuException hubSnapshot(PiliHubModel.HubSnapshotRequest param) throws Exception {
    byte[] body = Json.encode(param).getBytes(Constants.UTF_8);
