...
public class PiliStatManager extends PiliManager {
   ...
   */
  public PiliStatModel.StatResponse[] getStatUpflow(PiliStatModel.GetStatUpflowRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { FLOW_DEFAULT_SELECT };
    }
    String url = server + "/statd/upflow";
    StringMap formMap = new StringMap();
    byte[] data = StringUtils.utf8Bytes(formMap.formString());
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatResponse[] getStatDownflow(PiliStatModel.GetStatDownflowRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { FLOW_DEFAULT_SELECT };
    }
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatResponse[] getStatCodec(PiliStatModel.GetStatCodecRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { CODEC_DEFAULT_SELECT };
    }
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatGroupResponse[] groupStatCodec(PiliStatModel.GroupStatCodecRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { CODEC_DEFAULT_SELECT };
    }
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatResponse[] getStatNrop(PiliStatModel.GetStatNropRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { NROP_DEFAULT_SELECT };
    }
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatGroupResponse[] groupStatNrop(PiliStatModel.GroupStatCodecRequest param) throws Exception {
    if (param.select.length == 0) {
      param.select = new String[] { CODEC_DEFAULT_SELECT };
    }
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatResponse[] getStatCaster(PiliStatModel.GetStatCasterRequest param) throws Exception {
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatResponse[] getStatPub(PiliStatModel.GetStatPubRequest param) throws Exception {
    String url = this.server + "/statd/caster";
    StringMap queryMap = new StringMap();
    queryMap.put("select", param.select);
    queryMap.put("begin", param.commonRequest.begin);
   ...
   * @throws QiniuException 异常
   */
  public PiliStatModel.StatGroupResponse[] groupStatPub(PiliStatModel.GroupStatCasterRequest param) throws Exception {
    String url = this.server + "/statd/caster";
    StringMap queryMap = new StringMap();
    queryMap.put("select", param.select);
    queryMap.put("begin", param.commonRequest.begin);
