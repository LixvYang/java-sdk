...
public class PiliStreamManager extends PiliManager {
   ...
   */
  public PiliStreamModel.GetStreamsListResponse getStreamsList(PiliStreamModel.GetStreamListRequest param)
      throws Exception {
    StringMap queryMap = new StringMap();
    queryMap.put("hub", param.hub);
    queryMap.put("liveonly", param.liveOnly);
    queryMap.put("prefix", param.prefix);
    queryMap.put("limit", param.limit);
    queryMap.put("marker", param.marker);
    String url = server + "/v2/hubs/" + param.hub;
   ...
   * @throws QiniuException 异常
   */
  public PiliStreamModel.GetStreamBaseInfoResponse getStreamBaseInfo(String hub, String stream) throws Exception {
    String url = server + "/v2/hubs/" + hub + "/" + PiliStreamModel.encodeStream(stream);
   ...
   * @throws QiniuException 异常
   */
  public QiniuException streamDisable(String hub, String stream, String disabledTill, String disablePeriodSecond)
      throws Exception {
    String url = server + "/v2/hubs/" + hub + "/streams/" + PiliStreamModel.encodeStream(stream) + "/disabled";
    HashMap<String, String> req = new HashMap<>();
    req.put("hub", hub);
    req.put("encodedStreamTitle", PiliStreamModel.encodeStream(stream));
    ...
    Response response = client.post(url, body, null, Client.JsonMime);
   ...
   * @throws QiniuException 异常
   */
  public PiliStreamModel.GetStreamLiveStatusResponse getStreamLiveStatus(String hub, String stream) throws Exception {
    String url = server + "/v2/hubs/" + hub + "/streams/" + PiliStreamModel.encodeStream(stream) + "/live";
    Response response = client.get(url);
  ...
  public PiliStreamModel.GetStreamHistoryResponse getStreamHistory(long start, long end, String hub, String stream)
      throws Exception {
    String url = server + "/v2/hubs/" + hub + "/streams/" + PiliStreamModel.encodeStream(stream) + "/historyactivity";
    StringMap queryMap = new StringMap();
   ...
   * @throws QiniuException 异常
   */
  public PiliStreamModel.StreamSaveasResponse streamSaveas(PiliStreamModel.StreamSaveasRequest param) throws Exception {
    String url = server + "/v2/hubs/" + param.hub + "/streams/" + PiliStreamModel.encodeStream(param.stream)
        + "/saveas";
   ...
   */
  public QiniuException streamConverts(String hub, String stream, String[] converts) throws Exception {
    String url = server + "/v2/hubs/" + hub + "/streams/" + PiliStreamModel.encodeStream(stream) + "/converts";
    HashMap<String, String[]> req = new HashMap<>();
