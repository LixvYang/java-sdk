...
public final class TestConfig {
    ...
    public static TestFile[] getRetryTestFileArray() {
        ...
        Region region00 = new Region.Builder().region("custom").srcUpHost("mock.qiniu.com", "mock-na0.qiniup.com")
                .accUpHost("mock.qiniu.com", "mock-upload-na0.qiniup.com").build();
        Region region01 = new Region.Builder().region("custom").srcUpHost("mock.qiniu.com", "up-na0.qiniup.com")
                .accUpHost("mock.qiniu.com", "upload-na0.qiniup.com").build();
